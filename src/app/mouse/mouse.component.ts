...
export class MouseComponent implements OnInit {
  ...
  letters = ['H', 'B','J','C', 'G', 'E', 'I', 'D', 'A', 'F'];
  words = ['digunakan', 'Mouse', 'untuk', 'sangat', 'mudah'];
  wordsExc = ['mahir', 'hingga', 'sesering', 'Latihan', 'mungkin', 'komputer', 'menggunakan', 'untuk'];
  ...
  dropLetters(event: CdkDragDrop<string[]>) {
    ...
    var sorted = false;
    if(this.letters[0]=='A' && this.letters[1]=='B' && this.letters[2]=='C' && this.letters[3]=='D' && this.letters[4]=='E'
      && this.letters[5]=='F'&& this.letters[6]=='G'&& this.letters[7]=='H'&& this.letters[8]=='I'&& this.letters[9]=='J'){
      sorted= true;
    }
  ...
  dropWordsExc(event: CdkDragDrop<string[]>) {
    ...
    if(this.wordsExc[0]=='Latihan' && this.wordsExc[1]=='untuk' && this.wordsExc[2]=='menggunakan'
      ...
      && this.wordsExc[6]=='hingga' && this.wordsExc[7]=='mahir' ){
      sorted= true;
    }
